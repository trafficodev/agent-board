...
from agent_board import card_bulk
...
from agent_board.models import AddNote, BulkCards, CreateCard, CreateEdge, MAX_BULK_OPERATIONS, MoveCard
...
class BulkCardsTest(unittest.TestCase):
    ...
    def test_a_cycle_stays_impossible_through_the_single_card_api(self):
        ...
        from agent_board.models import UpdateCard
        self.assertIsNone(
